...
export type SyncEventListener = (eventType: string, payload?: SyncEventPayload) => void
...
export function emitSyncEvent(eventType: string, payload?: SyncEventPayload): void {
