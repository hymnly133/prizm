...
export class McpClientManager {
  ...
  async connect(config: McpServerConfig): Promise<void> {
    ...
    const client = new Client({ name: 'prizm-mcp-client', version: '0.1.0' }, { capabilities: {} })
   ...
   */
  async callTool(fullName: string, args: Record<string, unknown>): Promise<McpCallToolResult> {
