/**
 * 工具元数据：用户友好显示名、文档链接、分类、scope 交互类型
 * 供客户端 ToolCallCard 与 ScopeInteractions 使用
 */
...
export type ScopeInteractionAction =
  | 'read'
  | 'create'
  | 'update'
  | 'delete'
...
export interface ToolMetadata {
  ...
  scopeInteraction?: ScopeInteractionAction
}
